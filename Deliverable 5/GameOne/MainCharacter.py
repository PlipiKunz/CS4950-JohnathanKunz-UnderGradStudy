...
class MainCharacter(GameObject):
    def __init__(self):
        sprs = [pygame.transform.scale(pygame.image.load('C:\\Users\\Johnathan\\Current Classes\\CS4950-JohnathanKunz-UnderGradStudy\\Deliverable 5\\GameOne\\blueSquare.png'), (100,100))]
